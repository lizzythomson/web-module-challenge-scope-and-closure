...
The closure is created when you created a new anonymous function. It is a function inside of another function that will access outside variables or parameters.

b. Compare and contrast calling `dansRoll` the first and second time. What is always the same? What could change?

The parameter name 'Dan' will always be the same. The closure remembers that parameter that was passed when dansRoll was created. The dice roll will be different each time it is called.

c. What is the lexical scope of `newRoll`?

newRoll is within the lexical scope of the inner function of personalDice
